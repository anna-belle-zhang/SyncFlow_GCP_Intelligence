...
### ADK Architect Agent: Dual-Agent Communication Architecture

The Architect Agent uses a sophisticated two-agent pattern for proposal analysis and implementation:
...
graph TB
    ...
    subgraph DataModels["Data Models<br/>(Communication)"]
