...
FACTLOG_SCHEMA = [
    {"name": "log_id", "type": "STRING", "mode": "REQUIRED", "description": "Unique log identifier (UUID)"},
    ...
    {"name": "start_time", "type": "TIME", "mode": "NULLABLE", "description": "Start time (HH:MM:SS)"},
    {"name": "end_time", "type": "TIME", "mode": "NULLABLE", "description": "End time (HH:MM:SS)"},
    {"name": "duration_min", "type": "INTEGER", "mode": "REQUIRED", "description": "Duration in minutes"},
    {"name": "duration_seconds", "type": "FLOAT64", "mode": "NULLABLE", "description": "Duration in seconds (computed from start/end times)"},
    {"name": "status", "type": "STRING", "mode": "REQUIRED", "description": "Execution status (success, failed, warning)"},
    {"name": "error_message", "type": "STRING", "mode": "NULLABLE", "description": "Error details if execution failed"},
    {"name": "created_at", "type": "TIMESTAMP", "mode": "NULLABLE", "description": "Timestamp when log was created"},
    {"name": "records_processed", "type": "INTEGER", "mode": "NULLABLE", "description": "Records processed"},
    {"name": "rows_processed", "type": "INTEGER", "mode": "NULLABLE", "description": "Rows processed (alias for records_processed)"},
    {"name": "bytes_processed", "type": "FLOAT64", "mode": "NULLABLE", "description": "Bytes of data processed"},
]
...
MINIETLREPORT_SCHEMA = [
    {"name": "run_id", "type": "STRING", "mode": "REQUIRED", "description": "Unique identifier for this extraction run"},
    {"name": "run_date", "type": "DATE", "mode": "REQUIRED", "description": "Date of extraction"},
    {"name": "run_timestamp", "type": "TIMESTAMP", "mode": "REQUIRED", "description": "Timestamp of extraction"},
    {"name": "extraction_phase", "type": "STRING", "mode": "REQUIRED", "description": "Phase (INVENTORY, LOGS, BILLING)"},
    {"name": "etlobjectscd2_new", "type": "INTEGER", "mode": "NULLABLE", "description": "Number of new records in etlobjectscd2"},
    {"name": "etlobjectscd2_updated", "type": "INTEGER", "mode": "NULLABLE", "description": "Number of updated records in etlobjectscd2"},
    {"name": "etlobjectscd2_total", "type": "INTEGER", "mode": "NULLABLE", "description": "Total records affected in etlobjectscd2"},
    {"name": "factlog_inserted", "type": "INTEGER", "mode": "NULLABLE", "description": "Number of rows inserted in factlog"},
    {"name": "factbilling_inserted", "type": "INTEGER", "mode": "NULLABLE", "description": "Number of rows inserted in factbilling"},
    {"name": "status", "type": "STRING", "mode": "REQUIRED", "description": "Extraction status (SUCCESS, FAILED, WARNING)"},
    {"name": "error_message", "type": "STRING", "mode": "NULLABLE", "description": "Error message if failed"},
    {"name": "duration_sec", "type": "INTEGER", "mode": "NULLABLE", "description": "Duration in seconds"},
]
